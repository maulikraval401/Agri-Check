...
import { ArrowLeft, Bug, Leaf, Syringe, Shield, Share2 } from 'lucide-react';
...
const T: Record<Language, Record<string, string>> = {
  en: { back: 'Back', symptoms: 'Symptoms', treatment: 'Treatment', prevention: 'Prevention', notFound: 'Crop not found', diseasesOf: 'Diseases of', diseases: 'diseases' },
  gu: { back: 'પાછળ', symptoms: 'લક્ષણો', treatment: 'ઉપચાર', prevention: 'નિવારણ', notFound: 'પાક મળ્યો નથી', diseasesOf: 'ના રોગો', diseases: 'રોગો' },
  hi: { back: 'पीछे', symptoms: 'लक्षण', treatment: 'उपचार', prevention: 'रोकथाम', notFound: 'फसल नहीं मिली', diseasesOf: 'के रोग', diseases: 'रोग' },
  mr: { back: 'मागे', symptoms: 'लक्षणे', treatment: 'उपचार', prevention: 'प्रतिबंध', notFound: 'पीक सापडले नाही', diseasesOf: 'चे रोग', diseases: 'रोग' },
  pa: { back: 'ਪਿੱਛੇ', symptoms: 'ਲੱਛਣ', treatment: 'ਇਲਾਜ', prevention: 'ਰੋਕਥਾਮ', notFound: 'ਫਸਲ ਨਹੀਂ ਮਿਲੀ', diseasesOf: 'ਦੇ ਰੋਗ', diseases: 'ਰੋਗ' },
  ta: { back: 'பின்', symptoms: 'அறிகுறிகள்', treatment: 'சிகிச்சை', prevention: 'தடுப்பு', notFound: 'பயிர் கிடைக்கவில்லை', diseasesOf: 'இன் நோய்கள்', diseases: 'நோய்கள்' },
};
...
export default function PestCropDetail() {
  ...
  const crop = cropId ? (pestsData[cropId] as CropData) : null;
      ...
      <div className="mt-4 flex items-center gap-4 rounded-[1.5rem] bg-[hsl(var(--primary))] p-5 text-[hsl(var(--primary-foreground))]">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-xs opacity-70">
            {crop.diseases.length} {t.diseases}
          </p>
        </div>
        <button
          type="button"
          onClick={async () => {
            const shareData = {
              ...
              text: `${cropName} ke rog aur ilaaj`,
      ...
      <div className="mt-6 grid gap-4">
        {crop.diseases.map((d, i) => {
          ...
          return (
            <article
              key={i}
              className="overflow-hidden rounded-[1.35rem] border border-[hsl(var(--card-border))] bg-[hsl(var(--card))] shadow-[var(--shadow-soft)]"
            >
              {d.image && (
                <div className="aspect-[16/10] w-full overflow-hidden bg-[hsl(var(--muted))]">
                  <img
                    src={d.image}
                    alt={dName}
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[.65rem] font-semibold uppercase opacity-60">{t.symptoms}</p>
                ...
                <div className="mt-3 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[.65rem] font-semibold uppercase opacity-60">{t.treatment}</p>
                ...
                <div className="mt-3 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[.65rem] font-semibold uppercase opacity-60">{t.prevention}</p>
